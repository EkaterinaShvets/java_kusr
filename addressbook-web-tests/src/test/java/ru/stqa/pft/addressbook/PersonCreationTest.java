...
public class PersonCreationTest {
  ...
  public void testPersonCreation() throws Exception {
    gotoNewPersonPage();
    fillPersonForm(new PersonData("Теодор", "Джеймс", "Уотсон", "г. Вязьма, ул. Ланского, д.6", "+7(923)123-43-21", "Лесничество им. Каракозова", "teodorJW@mail.bk", "7", "July", "1970", "teodorJW@mail.bk"));
  ...
  private void fillPersonForm(PersonData personData) {
    ...
    wd.findElement(By.name("work")).sendKeys(personData.getWorkname());
